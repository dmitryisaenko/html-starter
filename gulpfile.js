...
gulp.task('deploy', function() {
	...
	.pipe(rsync({
		root: 'app/',
		hostname: 'pobudist_ftp@pobudist.ftp.tools',
		destination: '/home/pobudist/',
		// include: ['*.htaccess'], // Included files
		exclude: ['**/Thumbs.db', '**/*.DS_Store', 'app/scss/*.*', 'app/img/_src/*.*', 'app/js/_*.*'], // Excluded files
		recursive: true,
		archive: true,
		silent: false,
		compress: true
